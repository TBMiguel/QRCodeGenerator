...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container-fluid text-center position-absolute top-50 start-50 translate-middle">
        <form class="needs-validation" action="{{route('code')}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="col-sm-4 position-absolute top-50 start-50 translate-middle">
                <label for="firstName" class="form-label">Digite o texto do QRCode</label>
